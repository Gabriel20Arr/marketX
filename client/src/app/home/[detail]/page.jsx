  ...
  return (
    <div className={styles.countForm}>
      ...
      <div className={styles.btn}>
        <h2 className={styles.price}> Precio: ${data.precio}</h2>
      </div>

      <div className={styles.btn}>
        <h2 className={styles.price}> Stock: {data.stock}</h2>
      </div>
      
      <div className={styles.btn}>
        <h2 className={styles.categoria}>Categoria: {data.categoria}</h2>
      </div>
      
      <div className={styles.btn}>
        <h2 className={styles.descripcion}>{data.descripcion}</h2>
      </div>  
